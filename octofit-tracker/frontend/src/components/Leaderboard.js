...
// example: my-codespace-8000.app.github.dev/api/leaderboard
...
export default function Leaderboard() {
  ...
  const fetchData = () => {
    ...
    fetch(url)
      ...
      .catch((err) => console.error('Fetch error (Leaderboard):', err))
  ...
  return (
    <div className="card">
      ...
      <div className="card-body">
        {items.length === 0 ? (
          <div className="text-muted">No leaderboard data.</div>
        ) : (
