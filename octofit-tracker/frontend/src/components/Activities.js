...
// example: my-codespace-8000.app.github.dev/api/activities
...
export default function Activities() {
  ...
  const fetchData = () => {
    ...
    fetch(url)
      ...
      .catch((err) => console.error('Fetch error (Activities):', err))
  ...
  return (
    <div className="card">
      <div className="card-header d-flex justify-content-between align-items-center">
        ...
        <div>
          <button className="btn btn-sm btn-outline-secondary me-2" onClick={fetchData} disabled={loading}>
